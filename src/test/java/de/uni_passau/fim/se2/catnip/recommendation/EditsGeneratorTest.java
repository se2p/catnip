...
public class EditsGeneratorTest {
    ...
    public void testOneBlockDifference() throws IOException, ParsingException {
        ...
        Edit addition1 = new Edit(new Label("StmtList", null), new Label("IfOnEdgeBounce0", null));
        ...
        Edit addition2 = new Edit(new Label("StmtList", null), new Label("IfOnEdgeBounce0", null), new ArrayList<>(left), new ArrayList<>(right));
        left = new ArrayList<>();
        right = new ArrayList<>();
        left.add(emptyLabel);
        left.add(emptyLabel);
        Edit addition3 = new Edit(new Label("StmtList", null), new Label("IfOnEdgeBounce0", null), new ArrayList<>(left), new ArrayList<>(right));
        left = new ArrayList<>();
        right = new ArrayList<>();
        left.add(emptyLabel);
        right.add(goTo);
        Edit addition4 = new Edit(new Label("StmtList", null), new Label("IfOnEdgeBounce0", null), new ArrayList<>(left), new ArrayList<>(right));
    ...
    public void testSameBlocksDifference() throws IOException, ParsingException {
        ...
        left.add(emptyLabel);
        left.add(ifOnEdge);
        Edit addition1 = new Edit(new Label("StmtList", null), new Label("ClearGraphicEffects0", null));
        Edit addition2 = new Edit(new Label("StmtList", null), new Label("ClearGraphicEffects0", null), new ArrayList<>(left), new ArrayList<>(right));
        left = new ArrayList<>();
        right = new ArrayList<>();
        right.add(emptyLabel);
        right.add(emptyLabel);
        Edit addition3 = new Edit(new Label("StmtList", null), new Label("ClearGraphicEffects0", null), new ArrayList<>(left), new ArrayList<>(right));
        left = new ArrayList<>();
        right = new ArrayList<>();
        left.add(ifOnEdge);
        right.add(emptyLabel);
        Edit addition4 = new Edit(new Label("StmtList", null), new Label("ClearGraphicEffects0", null), new ArrayList<>(left), new ArrayList<>(right));
        Set<Edit> additions = new LinkedHashSet<>();
        additions.add(addition1);
        additions.add(addition2);
        additions.add(addition3);
    ...
    public void testTooMuch() throws IOException, ParsingException {
        ...
        Edit deletion1 = new Edit(new Label("StmtList", null), new Label("IfOnEdgeBounce0", null));
        Edit deletion2 = new Edit(new Label("StmtList", null), new Label("NextCostume0", null));
    ...
    public void testProcedureDifference() throws IOException, ParsingException {
        ...
        Assertions.assertEquals(0, edit.getDeletions().size());
        Assertions.assertEquals(4, edit.getAdditions().size());
        Edit addition2 = new Edit(new Label("StmtList", null), new Label("TurnRight0", null));
        Set<Edit> additions = new LinkedHashSet<>();
        additions.add(addition2);
